...
> 输出目标：让 Claude 可以按清晰边界开发 P0/P1，不把系统做成追涨或漂亮空壳。  
...
tradegov/researchgov/companygov/marketregime 都只能作为只读输入源。任何写入必须是后续显式命令，且不能在 P0/P1 做。
...
- 复杂 GUI。
- 实时高频盘口。
- 真实 tradegov/researchgov/companygov adapter。
- 机器学习评分。
- 自动写入任何外部系统。
