...
def agent_briefing_contract(max_quote_age_days: int) -> Dict[str, object]:
    return {
        ...
        "stable_fields": [
            ...
            "data.daily.coverage_context.universe.sector_profile.top_industries",
            "data.daily.coverage_context.universe.sector_profile.top_concepts",
            "data.daily.coverage_context.universe.sector_profile.top_indexes",
