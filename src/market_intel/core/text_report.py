...
LABELS = {
    ...
    "single_name_or_thin_resonance": "单票独涨、联动弱",
    ...
    "thin_resonance_verify": "联动待确认",
    "watch": "观察",
    "duplicate_symbol_exposure": "多板块重复归属",
    ...
    "not_in_pool": "未纳入观察池",
    "foundation_pool_match": "基础观察池已覆盖",
    "draft_pool_match": "初筛池已覆盖",
...
def render_dashboard_today_focus(value: Dict[str, object], compact: bool = False) -> List[str]:
    lines = [
