...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="market-intel", description="A 股复盘工作台")
    subparsers = parser.add_subparsers(dest="resource")

    pool_parser = subparsers.add_parser("pool", help="覆盖池管理")
    pool_subparsers = pool_parser.add_subparsers(dest="action")

    list_parser = pool_subparsers.add_parser("list", help="列出池中标的")
    list_parser.add_argument("--pool", default=DEFAULT_POOL)
    list_parser.add_argument("--json", action="store_true", dest="as_json")

    coverage_parser = pool_subparsers.add_parser("coverage", help="覆盖率分析")
    ...
    quality_parser = pool_subparsers.add_parser("quality", help="数据质量详情")
    ...
    expansion_parser = pool_subparsers.add_parser("expansion", help="覆盖扩展候选导出")
    ...
    research_parser = pool_subparsers.add_parser("research", help="研究证据队列")
    ...
    universe_parser = pool_subparsers.add_parser("universe", help="全 A 基础清单补数")
    ...
    explain_parser = pool_subparsers.add_parser("explain", help="单个标的详情")
    ...
    add_parser = pool_subparsers.add_parser("add", help="添加标的到 universe")
    ...
    remove_parser = pool_subparsers.add_parser("remove", help="从 universe 移除标的")
    ...
    hotspots_parser = subparsers.add_parser("hotspots", help="热点板块排名")
    ...
    holdings_parser = subparsers.add_parser("holdings", help="持仓分析")
    holdings_subparsers = holdings_parser.add_subparsers(dest="action")
    impact_parser = holdings_subparsers.add_parser("impact", help="持仓影响分析")
    ...
    portfolio_parser = subparsers.add_parser("portfolio", help="持仓复核")
    portfolio_subparsers = portfolio_parser.add_subparsers(dest="action")
    portfolio_review_parser = portfolio_subparsers.add_parser("review", help="持仓优先级复核")
    ...
    portfolio_explain_parser = portfolio_subparsers.add_parser("explain", help="单个持仓详情")
    ...
    brief_parser = subparsers.add_parser("brief", help="每日简报")
    ...
    watchlist_parser = subparsers.add_parser("watchlist", help="观察清单")
    ...
    map_parser = subparsers.add_parser("map", help="产业链地图")
    ...
    daily_parser = subparsers.add_parser("daily", help="每日综合报告")
    ...
    dashboard_parser = subparsers.add_parser("dashboard", help="一屏工作台")
    ...
    focus_parser = subparsers.add_parser("focus", help="聚焦视图")
    ...
    review_parser = subparsers.add_parser("review", help="一键复盘（同步+报告+变化追踪+留档）")
    ...
    import_schema_parser = import_subparsers.add_parser("schema", help="查看导入 schema")
    import_schema_parser.add_argument("--json", action="store_true", dest="as_json")

    import_quotes_parser = import_subparsers.add_parser("quotes", help="导入行情 CSV")
    ...
    import_universe_parser = import_subparsers.add_parser("universe", help="导入 A 股清单 CSV")
    ...
    import_research_parser = import_subparsers.add_parser("research", help="导入研究证据 CSV")
    ...
    runtime_parser = init_subparsers.add_parser("runtime", help="初始化运行时目录")
    ...
    validate_runtime_parser = validate_subparsers.add_parser("runtime", help="验证运行时数据")
    ...
    status_parser = subparsers.add_parser("status", help="状态诊断")
    status_subparsers = status_parser.add_subparsers(dest="action")
    status_runtime_parser = status_subparsers.add_parser("runtime", help="运行时状态")
    ...
    agent_parser = subparsers.add_parser("agent", help="Agent 工作流")
    agent_subparsers = agent_parser.add_subparsers(dest="action")
    agent_plan_parser = agent_subparsers.add_parser("plan", help="Agent 状态检查")
    ...
    agent_briefing_parser = agent_subparsers.add_parser("briefing", help="Agent 综合简报")
    ...
    agent_next_parser = agent_subparsers.add_parser("next", help="下一步操作")
    ...
    journal_parser = subparsers.add_parser("journal", help="日报留档")
    journal_subparsers = journal_parser.add_subparsers(dest="action")
    journal_save_parser = journal_subparsers.add_parser("save", help="保存日报")
    ...
    journal_list_parser = journal_subparsers.add_parser("list", help="列出日报")
    ...
    journal_latest_parser = journal_subparsers.add_parser("latest", help="最新日报")
    ...
    journal_show_parser = journal_subparsers.add_parser("show", help="查看指定日报")
    ...
    journal_compare_parser = journal_subparsers.add_parser("compare", help="对比两份日报")
    ...
    journal_timeline_parser = journal_subparsers.add_parser("timeline", help="日报时间线")
    ...
    journal_note_parser = journal_subparsers.add_parser("note", help="添加复盘笔记")
    ...
    journal_notes_parser = journal_subparsers.add_parser("notes", help="查看复盘笔记")
